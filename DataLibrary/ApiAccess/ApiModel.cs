...
{
    // Json data gets unpacked using this format.
    ...
    public class location
    {
        ...
        public int location_epoch { get; set; }
    ...
    public class day
    {
        ...
        public double avgvid_km { get; set; }
    ...
    public class hour
    {
        ...
        public double precipe_mm { get; set; }
        public double precipe_in { get; set; }
